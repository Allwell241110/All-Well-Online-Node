...
router.post('/process', async (req, res) => {
  ...
  try {
    ...
    if (paymentMethod === 'prepaid') {
      ...
      const accessToken = await getMomoToken(); // Reuse or refresh token
      ...
      console.log('Payment request sent with ref:', referenceId);
    }
...
router.post('/callback', async (req, res) => {
  try {
    ...
    // Update the corresponding order in your database
